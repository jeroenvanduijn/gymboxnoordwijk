          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg">{siteConfig.gym.address}</p>
                <p className="text-gray-600">{siteConfig.gym.postalCode} {siteConfig.gym.city}</p>
              </div>
              ...
              <div>
                ...
                <a href={`mailto:${siteConfig.gym.email}`} className="text-primary hover:underline text-lg">{siteConfig.gym.email}</a>
              </div>
              ...
              <div>
                ...
                <a href={`tel:${siteConfig.gym.phone}`} className="text-primary hover:underline text-lg">{siteConfig.gym.phone}</a>
              </div>
              ...
              {/* Follow Us */}
              <div>
                <h3 className="text-lg font-bold mb-3">{contact.followUs}</h3>
                <div className="flex gap-4">
                  {siteConfig.gym.socials.instagram && (
                    <a href={siteConfig.gym.socials.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-primary hover:text-white transition-all">
                  ...
                  {siteConfig.gym.socials.facebook && (
                    <a href={siteConfig.gym.socials.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center text-gray-600 hover:bg-primary hover:text-white transition-all">
            ...
            <div className="space-y-8">
              <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed">{contact.routeDescription}</p>
              </div>
