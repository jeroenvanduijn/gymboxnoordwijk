export const translations = {
  nl: {
    ...
    zelftest: {
      ...
      subtitle: "Benieuwd waar je nu staat?",
      description:
        "Doe onze **7 minuten Fitness Reality Check** en krijg helder inzicht in je kracht, conditie, energie en leefstijl.",
      noJudgement: "Geen oordeel. Geen verkooppraat. Alleen duidelijkheid.",
      stats: {
        duration: "7 minuten",
        questions: "18 vragen",
        result: "Persoonlijk resultaat",
      },
      cta: "Doe de test",
      exampleTitle: "Voorbeeldvragen",
      examples: [
        "Hoe vaak beweeg je per week?",
        "Heb je nog energie na je werkdag?",
    ...
    programs: {
      ...
      primaryOffer: {
        ...
        description:
          "Het perfecte startpunt. Leer ons kennen, bespreek je doelen en ontdek welk programma bij je past.",
        bullets: [
      ...
      items: {
        group: {
          title: "Groepslessen",
          description:
            "Word gezonder, ga voor gezelligheid. Word lid van onze community en behaal je sportieve doelen sneller met onze groepslessen.",
        },
        personal: {
          title: "Personal Training",
          description:
            "Behaal sneller echt resultaat. Werk met één van onze gespecialiseerde trainers om je resultaat een boost te geven.",
        },
        nutrition: {
          title: "Voedingscoaching",
          description:
            "Start met wat je eet. Wanneer je jouw trainingen koppelt aan goede eetgewoontes, geef je jouw resultaten een boost.",
        },
      },
    },
    waarom: {
    ...
    forms: {
      ...
      goal: "Primair Doel",
      goals: {
        general: "Fitter worden",
        weightloss: "Afvallen",
        muscle: "Spiermassa opbouwen",
        sport: "Sportprestaties verbeteren",
        other: "Anders",
      },
      submit: "Verstuur",
      send: "Verstuur Bericht",
      bookIntro: "Plan je Gratis Intro",
      placeholder: {
        name: "Jan Jansen",
    ...
    starten: {
      title: "Plan een Gratis Intro",
      subtitle: "Zet de eerste stap naar een gezonder, sterker jij.",
      formTitle: "Boek je Gratis Intro",
      success: {
        title: "Geregeld!",
        message:
          "Bedankt voor je aanmelding. We nemen binnen 24 uur contact met je op om een moment te plannen.",
      },
    },
    contact: {
      title: "Bezoek ons",
    ...
    popup: {
      ...
      subtitle: "Ontdek waarom wij de beste gym van Noordwijk zijn.",
      disclaimer: "Wij behandelen je gegevens vertrouwelijk.",
    },
    pricing: {
  ...
  en: {
    ...
    zelftest: {
      ...
      subtitle: "Curious where you stand right now?",
      description:
        "Take our **7-minute Fitness Reality Check** and get clear insights into your strength, fitness, energy and lifestyle.",
      noJudgement: "No judgement. No sales talk. Just clarity.",
      stats: {
        duration: "7 minutes",
    ...
    programs: {
      title: "Our Programs",
      subtitle: "Whether you're a beginner or advanced, we have a plan for you.",
      mostPopular: "Most Popular",
      learnMore: "Learn More",
      primaryOffer: {
        name: "Free Intro Session",
        description:
          "The perfect starting point. Get to know us, discuss your goals and discover which program suits you.",
        bullets: [
          "No-obligation introductory talk",
          "Personal advice",
          "Guided gym tour",
        ],
      },
      items: {
        group: {
          title: "Group Classes",
          description:
            "Get healthier, enjoy the community. Join our group classes and reach your fitness goals faster together.",
        },
        personal: {
          title: "Personal Training",
          description:
            "Achieve real results faster. Work with one of our specialized trainers to boost your progress.",
        },
        nutrition: {
          title: "Nutrition Coaching",
          description:
            "Start with what you eat. When you combine training with good eating habits, you'll amplify your results.",
        },
      },
    },
    waarom: {
    ...
    forms: {
      ...
      submit: "Submit",
      send: "Send Message",
      bookIntro: "Book Your Free Intro",
      placeholder: {
        name: "John Doe",
    ...
    starten: {
      ...
      subtitle: "Take the first step towards a healthier, stronger you.",
      formTitle: "Book Your Free Intro",
      success: {
        title: "You're all set!",
        message:
          "Thanks for booking your intro. We'll contact you within 24 hours to schedule a time that works for you.",
      },
    },
    contact: {
      title: "Visit Us",
    ...
    popup: {
      ...
      subtitle: "Find out why we are the best gym in Noordwijk.",
      disclaimer: "We treat your information confidentially.",
    },
    pricing: {
